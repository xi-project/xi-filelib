...
class FolderItemTest extends \Xi\Tests\Filelib\TestCase
{
    /**
     * @test
     */
    ...
    {
        $this->assertTrue(class_exists('Xi\Filelib\Folder\FolderItem'));
    ...
    {
        $this->assertInstanceOf('Xi\Filelib\Folder\FolderItem', FolderItem::create(array()));
    }
