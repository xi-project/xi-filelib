...
CREATE TABLE xi_filelib_versioned (uuid VARCHAR(255) NOT NULL, version VARCHAR(255) NOT NULL, resource_id INT NOT NULL, PRIMARY KEY(uuid, version));
...
ALTER TABLE xi_filelib_versioned ADD CONSTRAINT FK_DE91B4E789329D25 FOREIGN KEY (resource_id) REFERENCES xi_filelib_resource (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
