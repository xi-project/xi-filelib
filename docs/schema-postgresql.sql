CREATE TABLE xi_filelib_file (id INT NOT NULL, folder_id INT NOT NULL, resource_id INT NOT NULL, fileprofile VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, date_created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, status INT NOT NULL, uuid VARCHAR(36) NOT NULL, data TEXT NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE xi_filelib_resource (id INT NOT NULL, hash VARCHAR(255) NOT NULL, mimetype VARCHAR(255) NOT NULL, filesize INT NOT NULL, exclusive BOOLEAN NOT NULL, date_created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, data TEXT NOT NULL, PRIMARY KEY(id));
