CREATE TABLE xi_filelib_file (id INTEGER NOT NULL, folder_id INTEGER NOT NULL, resource_id INTEGER NOT NULL, fileprofile VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, filelink VARCHAR(255) DEFAULT NULL, date_created DATETIME NOT NULL, status INTEGER NOT NULL, uuid VARCHAR(36) NOT NULL, PRIMARY KEY("id"));
...
CREATE TABLE xi_filelib_resource (id INTEGER NOT NULL, hash VARCHAR(255) NOT NULL, mimetype VARCHAR(255) NOT NULL, filesize INTEGER DEFAULT NULL, "exclusive" BOOLEAN NOT NULL, date_created DATETIME NOT NULL, versions CLOB NOT NULL, PRIMARY KEY("id"));
